...
const eventPC = () => {
    ...
    const header_knrh_1_0_0_elmBg = document.querySelector('#header_knrh_1_0_0__bg_1');
...
const eventMB = () => {
    ...
    const header_knrh_1_0_0_elmBg = document.querySelector('#header_knrh_1_0_0__bg_2');
    for (let i = 0; i < elmClick.length; i++) {
        elmClick[i].addEventListener('click', () => {
            document.querySelector('#header_knrh_1_0_0__bg_1').style.display = 'none';
...
addEventListener("resize", () => {
    resizeHeader();
    document.querySelector('#header_knrh_1_0_0__bg_1').style.display = 'none';
    document.querySelector('#header_knrh_1_0_0__bg_2').style.display = 'none';
});
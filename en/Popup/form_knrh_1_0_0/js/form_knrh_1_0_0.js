            ...
            <article>
                ...
                <div class="form_knrh_1_0_0__item form-group">
                    <select name="iservice">
                        ...
                        <option value="Cắt mí - Bấm mí">Eyelid surgery</option>
                        <option value="Nâng mũi">Rhinoplasty</option>
                        <option value="Nâng ngực">Breast augmentation</option>
                        <option value="Giảm mỡ">Body Aesthetics</option>
                        <option value="Hàm mặt">Jaw and facial contouring</option>
                        <option value="Tạo hình môi">Lip shaping</option>
                        <option value="Phun xăm">Cosmetic tattooing</option>
                        <option value="Trị nám - Tàn nhang">Treat melasma - freckles</option>
                        <option value="Trị mụn - Mụn thịt">Acne treatment</option>
                        <option value="Căng da - Cấy mỡ">Skin tightening</option>
                        <option value="Thẩm mỹ khác">Other aesthetics</option>
                    </select>
                    <div class="form-message"></div>
                </div>
